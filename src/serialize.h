...
unsigned int GetSerializeSize(const std::basic_string<C, T, A>& str, int, int = 0);
template <typename Stream, typename C, typename T, typename A>
void Serialize(Stream& os, const std::basic_string<C, T, A>& str, int, int = 0);
template <typename Stream, typename C, typename T, typename A>
void Unserialize(Stream& is, std::basic_string<C, T, A>& str, int, int = 0);
